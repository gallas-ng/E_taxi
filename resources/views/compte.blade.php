...
<div class="row justify-content-center mb-4 " style="width: 100%;">
				@if(Auth::check() && Auth::user()->type == 'client')
					<div class="col-lg-10 col-md-10">
                        ...
                        <div class="card-header" style="background-color: rgba(1, 4, 136, 0.9);color:white;"> Votre Compte Client </div>
                        <div class="card-body">
				...
				@if(Auth::check() && Auth::user()->type == 'chauffeur')
					<div class="col-lg-4 col-md-6">
						<div class="card" style="width: 100%;">
                        <div class="card-header" style="background-color: rgba(1, 4, 136, 0.9);color:white;"> Votre Compte Chauffeur </div>
                        <div class="card-body">
							<h5 class="card-title">  {{ $user0->prenom }}  {{ $user0->nom }}</h5>
							<h6 class="card-subtitle mb-2 text-muted">Telephone: {{ $user0->tel }} </h6>
							<h6 class="card-subtitle mb-2 text-muted">Email: {{ $user0->email }} </h6>
				...
				@if(Auth::check() && Auth::user()->type == 'admin')
					<div class="col-lg-4 col-md-6">
						<div class="card" style="width: 100%;">
                        <div class="card-header" style="background-color: rgba(1, 4, 136, 0.9);color:white;"> Votre Compte Administrateur </div>
						<div class="card-body">
