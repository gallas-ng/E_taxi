...
<div class="text text-center mb-3" style="font-size: Large;background-color: rgba(1, 4, 136, 0.9);color:antiquewhite;border-raduis: 6px;width: 80%;" > Clic gauche == Point de Depart/ Clic droit == Point d'Arrivee </div> 

<div class="col-md-14 mb-3" >
   
<div class="row align-items-top">
    <div class="col-md-7">
        <div id="map" style="height: 400px; height: 600px;"></div>
    </div>
    <div class="col-md-5">
        <div class="card">
                <div class="card-header" style="background-color: #1acc8d;color:aliceblue;">Prendre une course</div>
                ...
                <div class="card-body">
                    <form id="reservation-form" method="POST" action="{{ route('reservations.store') }}">
                        ...
                        <div class="row mb-1">
                            <label for="" class="col-md-3 col-form-label text-md-end">latitude</label>
                            <div class="col-md-6">
                            <input type="text" readonly id="d_lat" name="d_latitude">
                            </div>
                        </div>
                        <div class="row mb-1">
                            <label for="" class="col-md-3 col-form-label text-md-end">longitude</label>
                            <div class="col-md-6">
