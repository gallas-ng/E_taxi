    ...
    <div class="text text-center" style="font-size: Large;" > ! Mes Reservations. </div> 
        <div class="col-md-14">
            ...
            <div class="row align-items-center">
                ...
                <div class="card mb-3">
                        <div class="card-header" style="background-color: rgba(1, 4, 136, 0.9);color:white;">Reservation en Attente</div>
                        <div class="card-body">
                ...
                <div class="card mb-3">
                        <div class="card-header" style="background-color: #1acc8d;color:white;">Reservation en Cours</div>
                        <div class="card-body">
                            <h5 class="card-title"> Depart:  {{ $reservation->adresse_depart }}</h5>
                            <h5 class="card-title"> Arrivée: {{ $reservation->adresse_arrivee }}</h5>
							<h6 class="card-subtitle mb-2 text-muted">Duree estimée: {{ $reservation->dure }} minutes</h6>
