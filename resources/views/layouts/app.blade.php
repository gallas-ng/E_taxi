...
<header id="header" class=" d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="{{url('/')}}"><span>Taximan</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{url('/')}}">A Propos</a></li>
          @guest
          ...
          <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img src="https://cdn-icons-png.flaticon.com/512/1246/1246314.png?w=740&t=st=1680149247~exp=1680149847~hmac=8ff84a45878bf3bf27eade4b9f4c69d983555645a8a94865e66d34a53048a969" alt="" width="32" height="32" class="rounded-circle me-2">
                                    {{ Auth::user()->name }}
                                </a>

                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('mon_compte', [Auth::user()->id]) }}" style="color:  rgba(1, 4, 136, 0.9);">
                                        Mon Compte
                                    </a>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
    ...
    <div id="app">
        <div class="container-fluid">
            <div id="sb" class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-md-3 col-lg-2 d-md-block sidebar collapse" style="width: 200px;">
                  ...
                  <button class="btn" style="background-color:  #1acc8d;">
            ...
            <li>
                ...
                <li class="nav-item">
                <a href="{{route('chauffeur.home')}}" class="nav-link link-dark" aria-current="page">
                <svg class="bi me-2" width="16" height="16"><use xlink:href="#home"/></svg>
                Home
                </a>
            </li>
            ...
            <li>
                <a href="{{route('chauffeur.vehicule', [Auth::user()->id])}}" class="nav-link link-dark">
                <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>
                Ma Voiture
                </a>
            </li>
            ...
            <li>
                <a href="{{route('r-p-c')}}" class="nav-link link-dark">
            ...
            <li>
                <a href="{{route('evaluations.index')}}" class="nav-link link-dark">
        ...
        @endauth
            ...
            <div class="py-4 col-md-9 ms-sm-auto col-lg-10 px-md-4">
                @yield('content')
                @yield('scripts')
            </div>
        </div>
